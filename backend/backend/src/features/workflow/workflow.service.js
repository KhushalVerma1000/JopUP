...
class WorkflowService {
  ...
  /**
   * NOTE: previously db.query.workflowTemplate.findFirst({ with: { stages: true } }).
   * Same crash as organization.service.js's db.query.organisation calls —
   * see that file's docstring. Fixed by reusing this.getStages(), which
   * already existed as a plain select elsewhere in this file.
   */
