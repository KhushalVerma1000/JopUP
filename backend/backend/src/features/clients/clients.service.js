...
class ClientsService {
  ...
  /**
   * NOTE: previously db.query.client.findFirst({ where }) — no `with` at
   * all, yet it crashed with the same "Cannot read properties of undefined
   * (reading 'referencedTable')" as organization.service.js's calls (see
   * that file's docstring for the full explanation — same root cause,
